...
public class ActivityLaunchMode1 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState){
		...
		clickBtnButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(ActivityLaunchMode1.this, ActivityLaunchMode2.class);
				//use  singleTop
		...
		textView.setText("value is " +testSharePreference.outputValueFromSharePreference(this, "id"));
