...
//
public class NoUIFragment extends Activity {
//
...
//		UiFragment data = new UiFragment();
//
//		@Override
//		public View onCreateView(LayoutInflater inflater, ViewGroup container,
//				Bundle savedInstanceState) {
//			View v = inflater.inflate(R.layout.fragment1,
//					container, false);
//
//			// Watch for button clicks.
//			Button button =(Button) v.findViewById(R.id.fragment1_start);
//			button.setOnClickListener(new OnClickListener() {
//				public void onClick(View v) {
//					data.mWorkFragment.restart();
//					
//				}
//			});
//
...
//			data.mWorkFragment = (RetainedFragment) fm.findFragmentByTag("work");
//
//			// If not retained (or first time running), we need to create it.
//			if (data.mWorkFragment == null) {
//				data.mWorkFragment = new RetainedFragment();
//				// Tell it who it is working with.
//				data.mWorkFragment.setTargetFragment(this, 0);
//				fm.beginTransaction().add(data.mWorkFragment, "work").commit();
//			}
//		}
//
//	}
